...
//        String INSERT_INTO_MOVIES = new StringBuilder().append("INSERT INTO ").append(TABLE_MOVIES).append("(").append(COLUMN_MOVIE_TITLE).append(", ").append(COLUMN_MOVIE_RELEASE_DATE).append(", ").append(COLUMN_MOVIE_RATING).append(", ").append(COLUMN_MOVIE_OVERVIEW).append(", ").append(COLUMN_MOVIE_TITLE).append(", ").append(COLUMN_MOVIE_POSTER_PATH).append(") VALUES ").append("('The Shawshank Redemption', '1994/09/10', 9.2, 'Two imprisoned men bond over a number of years, finding solace and eventual redemption through acts of common decency.', '/res/drawable/images/shawshank.png'),\n").append("('The Godfather', '1972/03/14', 9.2, 'The aging patriarch of an organized crime dynasty in postwar New York City transfers control of his clandestine empire to his reluctant youngest son.', '/res/drawable/images/godfather.png'),\n").append("('The Dark Knight', '2008/07/14', 9.0, 'When the menace known as the Joker wreaks havoc and chaos on the people of Gotham, Batman must accept one of the greatest psychological and physical tests of his ability to fight injustice.', '/res/drawable/images/darkknight.png'),\n").append("('The Godfather: Part II', '1972/03/14', 9.0, 'The early life and career of Vito Corleone in 1920s New York City is portrayed, while his son, Michael, expands and tightens his grip on the family crime syndicate.', '/res/drawable/images/godfather2.png'),\n").append("('12 Angry Men', '1957/4/10', 9.0, 'The aging patriarch of an organized crime dynasty in postwar New York City transfers control of his clandestine empire to his reluctant youngest son.', '/res/drawable/images/twelveangrymen.png'),\n").append("(\"Schindler's List\", '1993/00/00', 9.0, 'In German-occupied Poland during World War II, industrialist Oskar Schindler gradually becomes concerned for his Jewish workforce after witnessing their persecution by the Nazis.', '/res/drawable/images/schindlerslist.png');").toString();
        ...
        String INSERT_INTO_MOVIES = "INSERT INTO movies (" + COLUMN_MOVIE_ID + ", " + COLUMN_MOVIE_TITLE + ", " + COLUMN_MOVIE_RELEASE_DATE + ", " + COLUMN_MOVIE_DIRECTORS + ", " + COLUMN_MOVIE_RATING + ", " + COLUMN_MOVIE_OVERVIEW + ", " + COLUMN_MOVIE_POSTER_PATH + ")\n" + " VALUES\n" +
                ...
                "('tt0017136', 'Metropolis', '1927/01/10', 'Fritz Lang', 8.2, \"In a futuristic city sharply divided between the working class and the city planners, the son of the city's mastermind falls in love with a working-class prophet who predicts the coming of a savior to mediate their differences.\", 'poster_tt0017136'),\n" +
                "('tt0208092', 'Snatch', '2000/08/23', 'Guy Ritchie', 8.2, 'Unscrupulous boxing promoters, violent bookmakers, a Russian gangster, incompetent amateur robbers and supposedly Jewish jewelers fight to track down a priceless stolen diamond.', 'poster_tt0208092'),\n" +
                "('tt1832382', 'A Separation', '2011/02/01', 'Asghar Farhadi', 8.2, \"A married couple are faced with a difficult decision - to improve the life of their child by moving to another country or to stay in Iran and look after a deteriorating parent who has Alzheimer's disease.\", 'poster_tt1832382'),\n" +
                "('tt0095016', 'Die Hard', '1988/07/12', 'John McTiernan', 8.2, 'An NYPD officer tries to save his wife and several others taken hostage by German terrorists during a Christmas party at the Nakatomi Plaza in Los Angeles.', 'poster_tt0095016'),\n" +
                "('tt10872600', 'Spider-Man: No Way Home', '2021/12/13', 'Jon Watts', 8.2, \"With Spider-Man's identity now revealed, Peter asks Doctor Strange for help. When a spell goes wrong, dangerous foes from other worlds start to appear, forcing Peter to discover what it truly means to be Spider-Man.\", 'poster_tt10872600'),\n" +
                "('tt1255953', 'Incendies', '2010/09/03', 'Denis Villeneuve', 8.2, \"Twins journey to the Middle East to discover their family history and fulfill their mother's last wishes.\", 'poster_tt1255953'),\n" +
                "('tt0097576', 'Indiana Jones and the Last Crusade', '1989/05/24', 'Steven Spielberg', 8.2, \"In 1938, after his father Professor Henry Jones, Sr. goes missing while pursuing the Holy Grail, Professor Henry 'Indiana'//' Jones, Jr. finds himself up against Adolf Hitler's Nazis again to stop them from obtaining its powers.\", 'poster_tt0097576'),\n" +
                "('tt0040522', 'Bicycle Thieves', '1948/11/21', 'Vittorio De Sica', 8.2, \"In post-war Italy, a working-class man's bicycle is stolen, endangering his efforts to find work. He and his son set out to find it.\", 'poster_tt0040522'),\n" +
                "('tt8579674', '1917', '2019/12/04', 'Sam Mendes', 8.2, 'April 6th, 1917. As an infantry battalion assembles to wage war deep in enemy territory, two soldiers are assigned to race against time and deliver a message that will stop 1,600 men from walking straight into a deadly trap.', 'poster_tt8579674'),\n" +
                "('tt0986264', 'Like Stars on Earth', '2007/12/21', 'Aamir Khan, Amole Gupte', 8.2, 'An eight-year-old boy is thought to be a lazy trouble-maker, until the new art teacher has the patience and compassion to discover the real problem behind his struggles in school.', 'poster_tt0986264'),\n" +
                "('tt0363163', 'Downfall', '2004/9/16', 'Oliver Hirschbiegel', 8.2, \"Traudl Junge, the final secretary for Adolf Hitler, tells of the Nazi dictator's final days in his Berlin bunker at the end of WWII.\", 'poster_tt0363163'),\n" +
                "('tt0059578', 'For a Few Dollars More', '1965/12/18', 'Sergio Leone', 8.2, 'Two bounty hunters with the same intentions team up to track down an escaped Mexican outlaw.', 'poster_tt0059578'),\n" +
                "('tt0372784', 'Batman Begins', '2005/6/10', 'Christopher Nolan', 8.2, 'After training with his mentor, Batman begins his fight to free crime-ridden Gotham City from corruption.', 'poster_tt0372784'),\n" +
                "('tt5074352', 'Dangal', '2016/12/21', 'Nitesh Tiwari', 8.2, 'Former wrestler Mahavir Singh Phogat and his two wrestler daughters struggle towards glory at the Commonwealth Games in the face of societal oppression.', 'poster_tt5074352'),\n" +
                "('tt0012349', 'The Kid', '1921/1/16', 'Charles Chaplin', 8.2, 'The Tramp cares for an abandoned child, but events put their relationship in jeopardy.', 'poster_tt0012349'),\n" +
                "('tt0053291', 'Some Like It Hot', '1959/3/19', 'Billy Wilder', 8.2, 'After two male musicians witness a mob hit, they flee the state in an all-female band disguised as women, but further complications set in.', 'poster_tt0053291'),\n" +
                "('tt10272386', 'The Father', '2020/12/23', 'Florian Zeller', 8.2, 'A man refuses all assistance from his daughter as he ages. As he tries to make sense of his changing circumstances, he begins to doubt his loved ones, his own mind and even the fabric of his reality.', 'poster_tt10272386'),\n" +
                "('tt0042192', 'All About Eve', '1950/10/6', 'Joseph L. Mankiewicz', 8.2, 'A seemingly timid but secretly ruthless ingénue insinuates herself into the lives of an aging Broadway star and her circle of theater friends.', 'poster_tt0042192'),\n" +
                "('tt6966692', 'Green Book', '2018/11/16', 'Peter Farrelly', 8.2, 'A working-class Italian-American bouncer becomes the driver of an African-American classical pianist on a tour of venues through the 1960s American South.', 'poster_tt6966692'),\n" +
                "('tt0993846', 'The Wolf of Wall Street', '2013/12/25', 'Martin Scorsese', 8.2, 'Based on the true story of Jordan Belfort, from his rise to a wealthy stock-broker living the high life to his fall involving crime, corruption and the federal government.', 'poster_tt0993846'),\n" +
                "('tt0055031', 'Judgment at Nuremberg', '1961/12/18', 'Stanley Kramer', 8.2, 'In 1948, an American court in occupied Germany tries four Nazis judged for war crimes.', 'poster_tt0055031'),\n" +
                "('tt0105695', 'Unforgiven', '1992/8/7', 'Clint Eastwood', 8.2, 'Retired Old West gunslinger William Munny reluctantly takes on one last job, with the help of his old partner Ned Logan and a young man, The \"Schofield Kid.\"', 'poster_tt0105695'),\n" +
                "('tt0112641', 'Casino', '1995/11/22', 'Martin Scorsese', 8.2, 'A tale of greed, deception, money, power, and murder occur between two best friends: a mafia enforcer and a casino executive compete against each other over a gambling empire, and over a fast-living and fast-loving socialite.', 'poster_tt0112641'),\n" +
                "('tt0089881', 'Ran', '1985/6/1', 'Akira Kurosawa', 8.2, 'In Medieval Japan, an elderly warlord retires, handing over his empire to his three sons. However, he vastly underestimates how the new-found power will corrupt them and cause them to turn on each other...and him.', 'poster_tt0089881'),\n" +
                "('tt0457430', \"Pan's Labyrinth\", '2006/10/10', 'Guillermo del Toro', 8.2, 'In the Falangist Spain of 1944, the bookish young stepdaughter of a sadistic army officer escapes into an eerie but captivating fantasy world.', 'poster_tt0457430'),\n" +
                "('tt0469494', 'There Will Be Blood', '2007/12/26', 'Paul Thomas Anderson', 8.2, 'A story of family, religion, hatred, oil and madness, focusing on a turn-of-the-century prospector in the early days of the business.', 'poster_tt0469494'),\n" +
                "('tt0167404', 'The Sixth Sense', '1999/8/6', 'M. Night Shyamalan', 8.2, 'A frightened, withdrawn Philadelphia boy who communicates with spirits seeks the help of a disheartened child psychologist.', 'poster_tt0167404'),\n" +
                "('tt0268978', 'A Beautiful Mind', '2001/12/11', 'Ron Howard', 8.2, 'After John Nash, a brilliant but asocial mathematician, accepts secret work in cryptography, his life takes a turn for the nightmarish.', 'poster_tt0268978'),\n" +
                "('tt0071853', 'Monty Python and the Holy Grail', '1975/5/25', 'Terry Gilliam, Terry Jones', 8.2, 'King Arthur and his Knights of the Round Table embark on a surreal, low-budget search for the Holy Grail, encountering many, very silly obstacles.', 'poster_tt0071853'),\n" +
                "('tt0120382', 'The Truman Show', '1998/6/4', 'Peter Weir', 8.2, 'An insurance salesman discovers his whole life is actually a reality TV show.', 'poster_tt0120382'),\n" +
                "('tt0055630', 'Yojimbo', '1961/4/25', 'Akira Kurosawa', 8.1, 'A crafty ronin comes to a town divided by two criminal gangs and decides to play them against each other to free the town.', 'poster_tt0055630'),\n" +
                "('tt0040897', 'The Treasure of the Sierra Madre', '1948/1/15', 'John Huston', 8.1, 'Two down-on-their-luck Americans searching for work in 1920s Mexico convince an old prospector to help them mine for gold in the Sierra Madre Mountains.', 'poster_tt0040897'),\n" +
                "('tt0042876', 'Rashomon', '1950/8/26', 'Akira Kurosawa', 8.1, \"The rape of a bride and the murder of her samurai husband are recalled from the perspectives of a bandit, the bride, the samurai's ghost and a woodcutter.\", 'poster_tt0042876'),\n" +
                "('tt0057115', 'The Great Escape', '1963/6/20', 'John Sturges', 8.1, 'Allied prisoners of war plan for several hundred of their number to escape from a German camp during World War II.', 'poster_tt0057115');";
